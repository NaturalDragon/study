        ...
        switch (d && "object" == typeof d && "function" == typeof d.toJSON && (d = d.toJSON(e)), "function" == typeof rep && (d = rep.call(t, e, d)), typeof d) {
            ...
            case "object":
                ...
                if (rep && "object" == typeof rep)
                    for (n = rep.length, r = 0; r < n; r += 1) "string" == typeof rep[r] && (a = str(s = rep[r], d)) && i.push(quote(s) + (gap ? ": " : ":") + a);
                else
                    for (s in d) Object.prototype.hasOwnProperty.call(d, s) && (a = str(s, d)) && i.push(quote(s) + (gap ? ": " : ":") + a);
                return a = 0 === i.length ? "{}" : gap ? "{\n" + gap + i.join(",\n" + gap) + "\n" + o + "}" : "{" + i.join(",") + "}", gap = o, a
        }
    }
...
function(e) {
    if (e.atob) try {
        ...
        e.btoa = function(e) {
            e = String(e);
            for (var t, r, a, n, i = "", o = 0, d = e.length % 3; o < e.length;)((r = e.charCodeAt(o++)) > 255 || (a = e.charCodeAt(o++)) > 255 || (n = e.charCodeAt(o++)) > 255) && sd.log("Failed to execute 'btoa' on 'Window': The string to be encoded contains characters outside of the Latin1 range."), i += s.charAt((t = r << 16 | a << 8 | n) >> 18 & 63) + s.charAt(t >> 12 & 63) + s.charAt(t >> 6 & 63) + s.charAt(63 & t);
            return d ? i.slice(0, d - 3) + "===".substring(d) : i
        }, e.atob = function(e) {
            e = String(e).replace(/[\t\n\f\r ]+/g, ""), a.test(e) || sd.log("Failed to execute 'atob' on 'Window': The string to be decoded is not correctly encoded."), e += "==".slice(2 - (3 & e.length));
            for (var t, r, n, i = "", o = 0; o < e.length;) t = s.indexOf(e.charAt(o++)) << 18 | s.indexOf(e.charAt(o++)) << 12 | (r = s.indexOf(e.charAt(o++))) << 6 | (n = s.indexOf(e.charAt(o++))), i += 64 === r ? String.fromCharCode(t >> 16 & 255) : 64 === n ? String.fromCharCode(t >> 16 & 255, t >> 8 & 255) : String.fromCharCode(t >> 16 & 255, t >> 8 & 255, 255 & t);
            return i
        }
    }
}(window),
function() {
    var e, t, r, s = Array.prototype,
        ...
        u = _.each = function(e, t, r) {
            ...
            if (c && e.forEach === c) e.forEach(t, r);
                ...
                for (var s = 0, a = e.length; s < a; s++)
                    if (s in e && t.call(r, e[s], s, e) === p) return !1
            } else
                for (var n in e)
                    if (d.call(e, n) && t.call(r, e[n], n, e) === p) return !1
        };
    _.map = function(e, t) {
        var r = [];
        return null == e ? r : Array.prototype.map && e.map === Array.prototype.map ? e.map(t) : (u(e, function(e, s, a) {
            r.push(t(e, s, a))
        }), r)
    }, _.extend = function(e) {
        ...
        return e ? e.toArray ? e.toArray() : _.isArray(e) ? i.call(e) : _.isArguments(e) ? i.call(e) : _.values(e) : []
    }, _.values = function(e) {
        var t = [];
        ...
        return function() {
            ...
            o || !1 !== r.leading || (o = c);
            var l = t - (c - o);
            return s = this, a = arguments, l <= 0 || l > t ? (i && (clearTimeout(i), i = null), o = c, n = e.apply(s, a), i || (s = a = null)) : i || !1 === r.trailing || (i = setTimeout(d, l)), n
        }
        ...
        return t.prototype.setUrl = function(e) {
            ...
            for (var r in t || sd.log("DPURLParser::_parse -> Invalid URL"), this._fields) void 0 !== t[this._fields[r]] && (this._values[r] = t[this._fields[r]]);
        ...
        e.type || (e.type = e.data ? "POST" : "GET"), e = _.extend({
            success: function() {},
            error: function() {}
        }, e), sd.debug.protocol.ajax(e.url);
        var s, a = e.success,
            n = e.error;
        e.success = function(e) {
            a(e), s && (clearTimeout(s), s = null)
        }, e.error = function(e) {
            n(e), s && (clearTimeout(s), s = null)
        ...
        campaignParamsStandard: function(e, t) {
            ...
            return _.each(r, function(r, n, i) {
                -1 !== (" " + sd.source_channel_standard + " ").indexOf(" " + n + " ") ? s[e + n] = i[n] : a[t + n] = i[n]
            }), {
                $utms: s,
                otherUtms: a
            }
    ...
    if (_.isObject(sd.para.heatmap)) {
        ...
        l.push("data-sensors-click"), sd.para.heatmap.track_attr = l, _.isObject(sd.para.heatmap.collect_tags) ? !0 === sd.para.heatmap.collect_tags.div ? sd.para.heatmap.collect_tags.div = {
            ignore_tags: c
...
e.isSeachHasKeyword() ? e.hasKeywordHandle() : window.parent !== self && t.isSearchHasKeyword() ? t.verifyVtrackMode() : e.isStorageHasKeyword() ? e.storageHasKeywordHandle() : window.parent !== self && t.isStorageHasKeyword() ? t.verifyVtrackMode() : (sd.readyState.setState(3), new sd.JSBridge({
    type: "visualized",
...
send: function(e) {
    var t, r = this;
    _.isString(sd.para.server_url) && "" !== sd.para.server_url || _.isArray(sd.para.server_url) && sd.para.server_url.length ? (t = _.isArray(sd.para.server_url) ? sd.para.server_url[0] : sd.para.server_url, _.ajax({
        url: t,
        type: "POST",
...
else "string" == typeof sd.para.server_url && "" !== sd.para.server_url ? this.sendCall(sd.para.server_url, this.requestData.callback) : sd.log("当前 server_url 为空或不正确，只在控制台打印日志，network 中不会发数据，请配置正确的 server_url！")
...
getElementPosition: function(e, t, r) {
    ...
    if (i > 1) {
        for (var d = 0; d < i; d++) {
            sd.heatmap.getElementPath(n[d], r) === t && o.push(n[d])
        }
    ...
    return function(e) {
        ...
        for (var t = 0, r = e; _.ry(r).previousElementSibling().ele; r = _.ry(r).previousElementSibling().ele, t++);
        return t
    }(s)
},
...
start: function(e, t, r, s, a) {
    ...
    d.$element_selector = o || "", d.$element_path = sd.heatmap.getElementPath(t, sd.para.heatmap && "not_use_id" === sd.para.heatmap.element_selector);
    ...
    d = _.extend(d, n), "a" === r && sd.para.heatmap && !0 === sd.para.heatmap.isTrackLink ? _.trackLink({
        event: e,
        target: t
